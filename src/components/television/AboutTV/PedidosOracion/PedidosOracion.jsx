  ...
  return (
    <div className={css.container}>
      ...
      <p>
        ...
        <strong> confiar en Su</strong> poder y gracia para responder a nuestras
        oraciones de acuerdo con Su sabiduría perfecta.
      </p>
      <p>
        Por favor, envíen sus <strong>pedidos de oración</strong> a través del{" "}
        <Link
